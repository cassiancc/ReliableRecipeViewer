...
public class SidePanelOverlay extends AbstractRrvItemListOverlay {
    ...
    protected void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (isHoveringOverTitle(mouseX, mouseY)) {
            colour = -256;
            guiGraphics.renderComponentTooltip(font, List.of(Component.translatable(pageKey + ".hint1"), Component.translatable(pageKey + ".hint2"), Component.translatable("rrv.switch_tabs.hint")), mouseX, mouseY+10);
        }
