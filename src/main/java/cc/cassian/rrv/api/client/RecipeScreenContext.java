...
public record RecipeScreenContext(Screen screen, Font font, ReliableClientRecipe.RecipePosition recipePosition, GuiGraphicsExtractor guiGraphics, int absoluteMouseX, int absoluteMouseY, float partialTicks) {
