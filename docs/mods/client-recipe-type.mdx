...
public class ExampleModClientRecipeType implements ReliableClientRecipeType {
    ...
    public @Nullable ResourceLocation getGuiTexture() {
        return ResourceLocation.fromNamespaceAndPath("example-mod", "path/to/your/texture"); // Your type's gui texture.
    }
    ...
    public ResourceLocation getId() {
        return ResourceLocation.fromNamespaceAndPath("example-mod", "your_type_id"); //A unique id for your viewtype
    }
