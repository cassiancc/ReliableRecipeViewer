...
ItemView.addClientReloadCallback(() -> {
    ItemView.addWorldInteractionRecipe(new WorldInteractionClientRecipe(SlotContent.of(Items.STONE), SlotContent.of(Items.WOODEN_AXE), SlotContent.of(Items.STONE_AXE)));
});
```