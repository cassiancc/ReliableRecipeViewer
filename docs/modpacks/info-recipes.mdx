...
ItemView.addClientReloadCallback(() -> {
    ItemView.addInfoRecipe(new InfoClientRecipe(SlotContent.of(Items.STONE), "Stone can be found underground."));
    ItemView.addInfoRecipe(new InfoClientRecipe(SlotContent.of(Items.STONE), Component.translatable("rrv.info.stone")));
});
```
